library angular2.test.compiler.expression_parser.parser_spec;
...
main() {
  ...
  expectActionError(text) {
    return expect(() => parseAction(text));
  }
  expectBindingError(text) {
  ...
  describe("parser", () {
    describe("parseAction", () {
      ...
      describe("literals", () {
        ...
        it("should only allow identifier, string, or keyword as map key", () {
          ...
          expectActionError("{1234:0}").toThrowError(
              new RegExp("expected identifier, keyword, or string"));
        });
      });
      describe("member access", () {
        ...
        it("should only allow identifier or keyword as member names", () {
          ...
          expectActionError("x. 1234")
              .toThrowError(new RegExp("identifier or keyword"));
          expectActionError("x.\"foo\"")
              .toThrowError(new RegExp("identifier or keyword"));
        });
    ...
    describe("general error handling", () {
      ...
      it("should throw on missing expected token", () {
        expectActionError("a(b").toThrowError(new RegExp(
    ...
    describe("parseBinding", () {
      describe("pipes", () {
        ...
        it("should only allow identifier or keyword as formatter names", () {
          expectBindingError("\"Foo\"|(")
              .toThrowError(new RegExp("identifier or keyword"));
          expectBindingError("\"Foo\"|1234")
              .toThrowError(new RegExp("identifier or keyword"));
      ...
      it("should throw on assignment", () {
        expect(() => parseBinding("a=2"))
            .toThrowError(new RegExp("contain assignments"));
      });
      it("should throw when encountering interpolation", () {
    ...
    describe("parseInterpolation", () {
      ...
      it("should throw on empty interpolation expressions", () {
        expect(() => parseInterpolation("{{}}")).toThrowErrorWith(
 ...
 \'bar\' + \'baz\' }}''',
    ...
    describe("parseSimpleBinding", () {
      ...
      it("should throw when the given expression is not just a field name", () {
        expect(() => parseSimpleBinding("name + 1")).toThrowErrorWith(
