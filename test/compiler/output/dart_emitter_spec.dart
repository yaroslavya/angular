library angular2.test.compiler.output.dart_emitter_spec;
...
main() {
  ...
  describe("DartEmitter", () {
    ...
    it("should declare variables", () {
      ...
      expect(emitStmt(someVar.set(o.literal(1)).toDeclStmt(
          null, [o.StmtModifier.Final]))).toEqual('''final someVar = 1;''');
      expect(emitStmt(someVar
          .set(o.literal(1,
              new o.BuiltinType(o.BuiltinTypeName.Int, [o.TypeModifier.Const])))
          .toDeclStmt(null,
              [o.StmtModifier.Final]))).toEqual('''const int someVar = 1;''');
    ...
    it("should support operators", () {
      ...
      expect(emitStmt(lhs.identical(rhs).toStmt()))
          .toEqual("identical(lhs, rhs);");
    ...
    describe("classes", () {
      ...
      it("should support declaring fields", () {
        ...
        expect(emitStmt(new o.ClassStmt(
            ...
            null,
            [
              new o.ClassField("someField", o.INT_TYPE, [o.StmtModifier.Final])
            ],
            [],
            null,
            []))).toEqual([
