library angular2.test.testing.testing_internal_spec;
  ...
  describe("testing", () {
    describe("equality", () {
      it("should structurally compare objects", () {
        var expected = new TestObj(new TestObj({
          "one": [1, 2]
        }));
        var actual = new TestObj(new TestObj({
          "one": [1, 2]
        }));
        var falseActual = new TestObj(new TestObj({
          "one": [1, 3]
        }));
